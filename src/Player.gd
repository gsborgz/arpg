...
@onready var rest_menu: RestMenu = $RestMenu
...
func _ready():
	...
	PlayerManager.rest_handler.setup()


func _unhandled_input(event: InputEvent) -> void:
	PlayerManager.camera_handler.handle_camera_input(event)
	PlayerManager.rest_handler.handle_input(event)
...
func _init_instances() -> void:
	...
	PlayerManager.rest_menu = rest_menu
	...
	PlayerManager.rest_handler = PlayerRestHandler.new()
